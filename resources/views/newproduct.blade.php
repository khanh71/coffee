    ...
    <div class="card-body">
        ...
        <div class="row">
            <form class="col-12" id="newProductForm" method="post" action="{{route('new-product')}}">
                ...
                @foreach($errors->postNewProduct_Error->all() as $err)
                ...
                <div class="mb-3">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="proprice" name="proprice" value="{{old('proprice')}}" required min="1" max="100000000">
                        </div>
                    </fieldset>
