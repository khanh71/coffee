@extends('app')
@section('title','Chi phí nhập nguyên liệu')
@section('css')
...
<script type="text/javascript">
    ...
    $('#print').on('click', function() {
        ...
        var url = "{{route('print-cost',['dayfrom'=>':dayfrom','dayto'=>':dayto'])}}"
...
<div class="card">
    <div class="card-body">
        <div class="card-title ribbon ribbon-primary">
            <div class="glow"></div>Chi phí nhập nguyên liệu
        </div>
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <form class="form-inline col-md-12" action="{{route('report-cost')}}" method="POST">
                        {{csrf_field()}}
